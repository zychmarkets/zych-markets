(function(global){
  'use strict';
  const exchanges=Object.freeze(['binance','bybit','okx']);
  ...
  const equivalentMarket=(markets,current,exchange)=>marketForAsset(markets,current.asset,exchange,current.quoteAsset);
